...
export default {
    ...
    methods:{
        ...
        salvaAlteracoes(){
            console.log(this.telaBloqueada)
            ...
            {
                request.open('POST',rotas.pedidos.adicionar(this.PedidoBD[0].id),true)
            ...
            {
                request.open('POST',rotas.pedidos.remover(this.PedidoBD[0].id),true)
                request.setRequestHeader('X-CSRF-TOKEN',csrfToken)
                request.setRequestHeader("Content-Type","application/json")
            ...
            {
                request.open('POST',rotas.pedidos.editar(this.PedidoBD[0].id),true)
                request.setRequestHeader('X-CSRF-TOKEN',csrfToken)
                request.setRequestHeader("Content-Type","application/json")
...
<template>
    ...
    <div class="pedidos rounded border border-secondary " :class="{bloqueado : !telaDesbloqueada}">
        ...
        <div class="rounded border"> 
            <adicionarItemCarrinho :Produtos="ProdutosCadastrados" @insereObjeto="(item=>insereObjeto(item))" :disabled="salvando"></adicionarItemCarrinho>
        </div>
    </div>
</template>
